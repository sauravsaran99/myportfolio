  ...
  return (
    <div className='bg-[#19202398] relative mx-auto rounded-[2px] flex flex-row px-4 py-6 max-[455px]:justify-center'>
        ...
        <div className='flex flex-row gap-10 max-[743px]:gap-5 max-[455px]:gap-2'>
            ...
            <div  className='text-[#BDBDBD] text-sm cursor-pointer  max-[634px]:text-xs'><a href='https://drive.google.com/file/d/1xYjrRidEQkD9H3Qkn1zbJ_hRjYRd2Z7K/view?usp=sharing'>RESUME</a></div>
        </div>
    </div>
  )
}